...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 mt-5">
            ...
            <form class="form-auth needs-validation" action="login.inc.php" method="post" novalidate>
                ...
                <button class="btn btn-lg btn-success btn-block" type="submit" value="loginsubmit" name="loginsubmit">Login</button>
                </div>
                <style>
                ...
                <p class="mt-3 text-muted link-primary text-center"><a href="../reset-password/">Forgot Password?</a></p>

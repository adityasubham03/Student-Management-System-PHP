            ...
            <form class="form-auth" action="includes/profile-edit.inc.php" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                if(isset($_GET['id'])){
                    ...
                    <select id="level" name="level" class="form-select" placeholder="Level">
                        ...
                        <option type="number" value="1" <?php if($employee['level']==1){?>selected<?php }?>>Admin/HOD/Teacher</option>
                        <option type="number" value="2" <?php if($employee['level']==2){?>selected<?php }?>>Student</option>
                    </select>
                        <?php } ?>
                    </div>
